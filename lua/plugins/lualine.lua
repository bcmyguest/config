...
-- Status line. Replaces the unmaintained galaxyline.nvim (which forced two
-- vim.lsp deprecation shims in init.lua). This is lualine's canonical
-- "evil_lualine" recipe — a faithful port of galaxyline's eviline look:
-- mode-coloured powerline blocks, diagnostics, git diff, filesize, progress.
return {
	...
	config = function()
		...
		-- Empty config; sections get pushed in below so left/right line up nicely.
		local config = {
			options = {
