...
return {
	{
		...
		keys = {
			...
			{ "<F5>",       function() require("dap").continue() end,                    desc = "Continue debugger" },
			{ "<Leader>do", function() require("dap").step_over() end,                   desc = "Step over" },
			{ "<Leader>di", function() require("dap").step_into() end,                   desc = "Step into" },
			{ "<Leader>b",  function() require("dap").toggle_breakpoint() end,           desc = "Toggle breakpoint" },
			{ "<Leader>B",  function() require("dap").toggle_breakpoint() end,           desc = "Toggle breakpoint" },
			{ "<Leader>dw", function() require('dapui').eval(nil, { enter = true }) end, desc = "Eval word under cursor" },
			...
			{ "<Leader>dt", function() require("dap").repl.open() end,          desc = "Open dap repl" },
